...
_GETENGINERECEIPTS = _descriptor.Descriptor(
  name='GetEngineReceipts',
  full_name='iroha.protocol.GetEngineReceipts',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tx_hash', full_name='iroha.protocol.GetEngineReceipts.tx_hash', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERY_PAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='get_engine_receipts', full_name='iroha.protocol.Query.Payload.get_engine_receipts', index=14,
...
_QUERY_PAYLOAD.fields_by_name['get_engine_receipts'].message_type = _GETENGINERECEIPTS
...
_QUERY_PAYLOAD.oneofs_by_name['query'].fields.append(
  _QUERY_PAYLOAD.fields_by_name['get_engine_receipts'])
_QUERY_PAYLOAD.fields_by_name['get_engine_receipts'].containing_oneof = _QUERY_PAYLOAD.oneofs_by_name['query']
...
DESCRIPTOR.message_types_by_name['GetEngineReceipts'] = _GETENGINERECEIPTS
